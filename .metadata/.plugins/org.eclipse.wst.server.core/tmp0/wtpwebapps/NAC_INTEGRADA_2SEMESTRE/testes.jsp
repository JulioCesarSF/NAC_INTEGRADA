...
<body>
	...
	<div class="container">
			...
			<div class="col-md-6">
				<div class="list-group">
					...
					<button type="button" class="btn ${retornoTesteConexao }"
						...
						Conexão ${excecao }</button>
				</div>
			</div>
			<div class="col-md-6">
				<div class="alert alert-info">Verde = Passou, Vermelho = Não
					Passou no teste</div>
			</div>
		</div>
				...
				<div id="login" class="collapse">
					...
					<form method="post" action="testes">
						...
						<div class="form-group">
							<input type="text" name="usuario" placeholder="Número do RM"
								class="form-control">
						</div>
						<div class="form-group">
		...
		<!-- FIM do formulário para testar conexão -->
	</div>
