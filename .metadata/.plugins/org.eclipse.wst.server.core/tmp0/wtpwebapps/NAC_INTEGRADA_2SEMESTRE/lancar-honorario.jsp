		...
		<div class="row">
			<div class="col-md-12">
				<form action="lancarHonorario" action="post">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label id="idData">Data Honorário:</label> <input type="date"
					...
					<div class="col-md-4">
						<div class="form-group">
							<label id="idObservacao">Observações:</label>
				...
				<table class="table table-hover" id="lista">
					...
					<thead>
						<tr>
							...
							<th style="text-align: center;">Data Honorário</th>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center;">Audiência</td>
